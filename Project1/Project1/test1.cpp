...
void list_A::insertpre(node* at, node* newnode)
{
    ...
    {
        newnode->next = at;
        newnode->previous = at->previous = this->head;// phải sửa dòng này!! tại sao at->previous lại là null ???
        if (at->previous)
        {
...
int main()
{
    ...
    sv4 = new node(444, "hihihi");
    sv5 = new node(555, "okokok");
    it5->insertl2(sv1);
    it5->insertl2(sv5);
    it5->insertl2(sv2);
